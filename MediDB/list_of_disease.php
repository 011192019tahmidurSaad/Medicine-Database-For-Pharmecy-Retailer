        ...
        <div class="container-foluid">
            <div class="row">
                ...
                <div class="col-sm-9 border-start border-secondary">
                    ...
                    <?php 
                    $sql = "SELECT * FROM disease_category";
                    ...
                    while($data = mysqli_fetch_assoc($query)){
                        ...
                        echo "<tr>
                              <td>$disease_name</td>
                              <td>$disease_entry_date</td>
                              <td><a href ='edit_disease.php?id= $disease_id' class='btn btn-secondary'>Edit</a>
                                  <a href ='edit_disease.php?id= $disease_id' class='btn btn-secondary'>Edit</a></td>";
