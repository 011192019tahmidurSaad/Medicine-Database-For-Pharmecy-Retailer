...
<head>
    ...
    <title>Expire Medicine List</title>
                ...
                <div class="col-sm-9 border-start border-secondary">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_assoc($query)){
                            ...
                            $today = new DateTime();
                            $expirationDate = new DateTime($store_medicine_expire_date);

                            if ($expirationDate <= $today) {
                                echo "<tr>
                                <td>$store_medicine_id</td>
...
<?php
    ...
    $expirationDateStr = "2023-08-31"; // Replace this with the actual expiration date

$today = new DateTime();
$expirationDate = new DateTime($expirationDateStr);

if ($expirationDate > $today) {
    echo "The item is still valid.";
} else {
