        ...
        <div class="container-foluid">
            <div class="row">
                ...
                <?php 
                    ...
                    $company_certification= $_GET['company_certification'];
        
                    $sql = "INSERT INTO company_category (company_name,company_certification)
                    VALUES ('$company_name','$company_certification')";
                ...
                ?>
                <form action="add_company.php" method="GET">
                    Company Name :<br>
                    <input type="text" name="company_name" required><br><br>
                    Certification :<br>
                    <input type="text" name="company_certification" required><br><br>
