<?php
    ...
    $spend_medicine_id = null;
    $spend_medicine_name=null;
    $spend_medicine_quantity= null;
    $spend_medicine_entry_date = null;
    $spend_medicine_expire_date =null;
 ?>
 <?php
   session_start();
...
<div class="container bg-light">
       ...
       if(isset($_GET['id'])){
        ...
        $spend_medicine_entry_date = $data['spend_medicine_entry_date'];
        $spend_medicine_expire_date= $data['spend_medicine_expire_date'];
     }
     ...
     if(isset($_GET['spend_medicine_name'])){
        ...
        $new_spend_medicine_entry_date= $_GET['spend_medicine_entry_date'];
        $new_spend_medicine_expire_date= $_GET['spend_medicine_expire_date'];

        $sql4 = "UPDATE spend_medicine SET
        spend_medicine_name =  '$new_spend_medicine_name',
        spend_medicine_quantity =  '$new_spend_medicine_quantity',
        spend_medicine_entry_date = '$new_spend_medicine_entry_date',
        spend_medicine_expire_date = '$new_spend_medicine_expire_date'
        WHERE store_medicine_id = '$new_spend_medicine_id' ";
     ...
     ?>
    <form action="edit_spend_medicine.php" method="GET">
        Medicine Name :<br>

        <select name="spend_medicine_name" id="">
            <?php 
            ...
            ?>
                <option value ='<?php echo $medicine_id; ?>' <?php 
                                                                 if($spend_medicine_name == $medicine_id){
                                                                    echo 'selected';
                                                                 }
                                                              ?> >
        ...
        Store Entry Date :<br>
        <input type="date" name="spend_medicine_entry_date" value="<?php echo $spend_medicine_entry_date; ?>"><br><br>
        Store Expire Date :<br>
        <input type="date" name="spend_medicine_expire_date" value="<?php echo  $spend_medicine_expire_date; ?>"><br><br>
