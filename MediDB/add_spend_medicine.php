...
<div class="container bg-light">
       ...
       if(isset($_GET['spend_medicine_name'])){
        ...
        $spend_medicine_entry_date= $_GET['spend_medicine_entry_date'];
        $spend_medicine_expire_date= $_GET['spend_medicine_expire_date'];
        
        $sql = "INSERT INTO spend_medicine (spend_medicine_name,
                                     spend_medicine_quantity,
                                     spend_medicine_entry_date,
                                     spend_medicine_expire_date)
        VALUES ('$spend_medicine_name','$spend_medicine_quantity',
                '$spend_medicine_entry_date','$spend_medicine_expire_date')";
    ...
    <?php
     ...
     ?>
    <form action="add_spend_medicine.php" method="GET">
        Medicine Name :<br>
        ...
        <input type="text" name="spend_medicine_quantity" required><br><br>
        Spend Entry Date :<br>
        <input type="date" name="spend_medicine_entry_date" required><br><br>
        Spend Expire Date :<br>
        <input type="date" name="spend_medicine_expire_date" required><br><br>
