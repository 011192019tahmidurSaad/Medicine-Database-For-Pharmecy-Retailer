...
<div class="container bg-light">
        ...
        while($data = mysqli_fetch_assoc($query)){
            ...
            echo "<tr>
                  ...
                  <td>$spend_medicine_entry_date</td>
                
                  <td><a href ='edit_spend_medicine.php?id= $spend_medicine_id' class='btn btn-secondary'>Edit</a>
                    <a href ='delete_spend_medicine.php?id= $spend_medicine_id' class='btn btn-danger'>Delete</a>
                  </td></tr>";
